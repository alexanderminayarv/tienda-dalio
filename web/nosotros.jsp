                ...
                <div class="row">
                    <div class="col-sm-4" >
                        <div class="left-sidebar">
                            <h2>¿Quienes Somos?</h2>
                            SOMOS UNA EMPRESA DEDICADA AL RUBRO DEL TRANSPORTE, NUESTRO OBJETIVO ES LLEGAR A TODO EL PERÚ PARA PODER AYUDAR CON EL MEDIO AMBIENTE Y PODER SEGUIR DESPLAZANDONOS DE LA FORMA QUE YA ESTAMOS ACOSTUMBRADOS.
                            </br></br>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="left-sidebar">
                            ...
                            MISIÓN: CONCIENTIZAR A LAS PERSONAS A TENER UNA NUEVA DEFINICIÓN DE TRANSPORTE, PARA ESTO TRAEMOS UNA DISTRIBUCIÓN DE MOTOS ELÉCTRICA DE ALTA CALIDAD Y TECNOLOGÍA. <BR></BR>
                            VISIÓN: CREAR UNA ALTERNATIVA DE TRANSPORTE SANA Y NO DESTRUCTIVA, ADEMÁS DE SER LA PRIMERA OPCIÓN PARA LOS PERUANOS.  <br></br>
                    ...
                    <div class="col-sm-4">
                        <div class="left-sidebar">
                            <br> 
                            <center><img src="images/Motoblanca.png" width="100%" alt=""/></center> <br></br> 
                        </div>
                    </div>         
                </div>
            </div>
