    ...
    <body>
        ...
        <section>
            <div class="container">
                ...
                <center><h2>CARACTERÍSTICAS</h2></center></br></br>
                <div class="row">
                    <div class="col-sm-4" >
                        <div class="left-sidebar">
                            <h2>Ventajas</h2>

                            - SON MÁS BARATAS QUE OTRO VEHÍCULOS DE TRANSPORTE. <br></br> 
                            - FÁCIL DE USAR Y APRENDER. <br></br>
                            - NO CONTAMINAN EL MEDIO AMBIENTE. <br></br>
                            - MOTOR RECARGABLE Y ECONÓMICO.  <br></br>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="left-sidebar">
                            <br> 
                            <center><img src="images/Moto roja.png" width="100%"> </center> <br></br>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="left-sidebar">
                                ...
                                <h2>Beneficios de nuestra empresa</h2>
                                <p style="text-align: right;">
                                    - CONTAMOS CON TALLERES DE MANEJO. <br></br> 
                                    - GARANTÍA DE 1 MES POR EL PRODUCTO. <br></br>
                                    - ATENCIÓN AL CLIENTE 24/7. <br></br>
                                </p>
