                ...
                <div class="row">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="#">
                                                Producto innovador y fácil de usar para el manejo del cliente; además de contar con carga eléctrica lo cual genera menos gasto y un manual de ayuda con respecto a su funcionamiento.
                                                </br></br></br>                         
                                                <b>Segmento Objetivo: </b>
                                                Personas con interés a transportarse de un lugar a otro a través de una moto eléctrica 
                                                </br></br></br>    
                                                <b>(Early adopters): </b>
                                                Jóvenes y adultos, entre 18 hasta los 50 años que manejen una moto eléctrica a menor costo y eficiente
                    ...
                    <c:forEach var="p" items="${productoss}">
                        <div class="col-sm-9 padding-right">
                            <h2 class="title text-center">PRODUCTO ELEGIDO</h2>
                            <div class="product-details"><!--product-details-->
                                <div class="col-sm-5">
                                    <div class="view-product">
                                        <img src="${p.getFoto()}" alt="" />
                                        <h3>NEW</h3>
                                    </div>
                                </div>
                                <div class="col-sm-7">
                                    <div class="product-information"><!--/product-information-->
                                        ...
                                        <form action="agregarproducto" method="post">
                                            <span>
                                                <span>US $${p.getPrecio()}</span>
                                                <a href="Controlador?accion=AgregarCarrito&id=${p.getId()}" class="btn btn-fefault cart" ${deshabilitado_o_habilitado}>
                                                    <i class="fa fa-shopping-cart"> Añadir al Carrito</i></a>
                                            </span>
                                        </form>
                                        <p style="text-align: justify;">${p.getDescripcion()}</p>
                                        Disponibilidad: <label style="color:${color};"> ${mensaje_stock}</label>
