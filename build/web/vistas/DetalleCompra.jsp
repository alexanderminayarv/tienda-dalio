...
<html>
    <head>
        ...
        <title>Detalle de Compras - Tienda DALIO</title>
                    ...
                    <table class="table table-condensed" id="shop-table">
                        <thead>
                            <tr class="cart_menu text-center">
                                ...
                                <td class="quantity">Precio Compra</td>
                            ...
                            <c:forEach var="p" items="${myDetalle}">  
                                <tr>
                                    <td class="cart_description text-center">
                                        <p>C00${p.getIdcompra()}</p>
                                    </td>   
                                    <td class="cart_description text-center">                                     
                                        <img src="${p.producto.getFoto()}" width="130" height="110">
                                        <p><i>${p.producto.nombres}</i></p>
                                    </td>
                                    <td class="cart_description text-center">
                                        <p>${p.getCantidad()}</p>
                                    </td>
                                    <td class="cart_description text-center">
                                        <p>US $${p.getPrecioCompra()}</p>
                                    </td>
                                    <td class="cart_description text-center">
                                        <p>US $${p.getCantidad()*p.getPrecioCompra()}</p>
                                    </td>
                                    <!--<td hidden>${suma=suma+p.getCantidad()*p.getPrecioCompra()}
                                    </td> -->
                                </tr>
                            </c:forEach>
                                <tr class="text-center" style="background-color: #F2F2F2;">
                                    <td colspan="3"></td>
                                    <td colspan="1"><p><b>Monto Total:</b></p></td>
                                    <td colspan="1"><p><b>US $${montoPagar}</b></p></td>
                                </tr>
                        </tbody>
                    </table>
                </div> 
